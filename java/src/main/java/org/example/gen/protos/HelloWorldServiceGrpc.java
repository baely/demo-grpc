...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.gen.protos.Helloworld.HelloWorldRequest,
      org.example.gen.protos.Helloworld.HelloWorldResponse> getHelloWorldMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "HelloWorld",
      requestType = org.example.gen.protos.Helloworld.HelloWorldRequest.class,
      responseType = org.example.gen.protos.Helloworld.HelloWorldResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.gen.protos.Helloworld.HelloWorldRequest,
      org.example.gen.protos.Helloworld.HelloWorldResponse> getHelloWorldMethod() {
    io.grpc.MethodDescriptor<org.example.gen.protos.Helloworld.HelloWorldRequest, org.example.gen.protos.Helloworld.HelloWorldResponse> getHelloWorldMethod;
    if ((getHelloWorldMethod = HelloWorldServiceGrpc.getHelloWorldMethod) == null) {
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getHelloWorldMethod = HelloWorldServiceGrpc.getHelloWorldMethod) == null) {
          HelloWorldServiceGrpc.getHelloWorldMethod = getHelloWorldMethod =
              io.grpc.MethodDescriptor.<org.example.gen.protos.Helloworld.HelloWorldRequest, org.example.gen.protos.Helloworld.HelloWorldResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "HelloWorld"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.gen.protos.Helloworld.HelloWorldRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.gen.protos.Helloworld.HelloWorldResponse.getDefaultInstance()))
              .setSchemaDescriptor(new HelloWorldServiceMethodDescriptorSupplier("HelloWorld"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void helloWorld(org.example.gen.protos.Helloworld.HelloWorldRequest request,
        io.grpc.stub.StreamObserver<org.example.gen.protos.Helloworld.HelloWorldResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceStub
    ...
    /**
     */
    public void helloWorld(org.example.gen.protos.Helloworld.HelloWorldRequest request,
        io.grpc.stub.StreamObserver<org.example.gen.protos.Helloworld.HelloWorldResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceBlockingStub
    ...
    /**
     */
    public org.example.gen.protos.Helloworld.HelloWorldResponse helloWorld(org.example.gen.protos.Helloworld.HelloWorldRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.gen.protos.Helloworld.HelloWorldResponse> helloWorld(
        org.example.gen.protos.Helloworld.HelloWorldRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO_WORLD:
          serviceImpl.helloWorld((org.example.gen.protos.Helloworld.HelloWorldRequest) request,
              (io.grpc.stub.StreamObserver<org.example.gen.protos.Helloworld.HelloWorldResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              org.example.gen.protos.Helloworld.HelloWorldRequest,
              org.example.gen.protos.Helloworld.HelloWorldResponse>(
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.gen.protos.Helloworld.getDescriptor();
    }
